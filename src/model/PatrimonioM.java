...
public class PatrimonioM {
    ...
    public PatrimonioM(Integer id, String codigo,String descricao,SubTipoM subTipo, GrauConservacaoM grau_conservacao, StatusM status, SalaM sala, String notaFiscal, OrgaoM entidade) {        this.id = id;
        this.codigo = codigo;
