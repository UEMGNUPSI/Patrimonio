...
public class UsuarioView extends javax.swing.JInternalFrame {
    ...
    public void atualizaTabelaUsuario() {
        ...
        for (UsuarioM usuario1 : listaUsuario) {
                    ...
                    if(usuario1.isAdmin() == true){dados[i][2] = "Administrador";}
                    else{dados[i][2] = "Comum";}
                    dados[i][3] = usuario1.getNome();
                    dados[i][4] = usuario1.getMasp();
                    dados[i][5] = usuario1.getContato();
                    i++;
        }
        String tituloColuna[] = {"ID", "Usuario", "Conta", "Nome", "MASP", "Contato"};
        ...
        tbeUsuario.getColumnModel().getColumn(0).setPreferredWidth(30);
        tbeUsuario.getColumnModel().getColumn(1).setPreferredWidth(300);
        tbeUsuario.getColumnModel().getColumn(2).setPreferredWidth(200);
        ...
        tbeUsuario.getColumnModel().getColumn(2).setCellRenderer(centralizado);
